...
bot.on('message', msg => {
  const helplist = new Discord.RichEmbed()
    ...
    .addField("**?poll**", "> Set up a yes or no answer questionairre for members to submit their response to as a vote in the form of reactions. To use properly, type your question after the command in the same message.")
